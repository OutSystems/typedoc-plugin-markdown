...
*Defined in [generics.ts:83](https://github.com/OutSystems/typedoc-plugin-markdown/blob/master/test/src/generics.ts#L83)*
...
*Defined in [generics.ts:15](https://github.com/OutSystems/typedoc-plugin-markdown/blob/master/test/src/generics.ts#L15)*
